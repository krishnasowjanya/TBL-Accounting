Feature: Update Organization Taxpayer Reject
...
And Select Approval outcome dropdown value to Reject for Update Ind
...
Examples:
    ...
    | tripscrmuser11  |Passw0rd | chrome|*ARN/00021463/2020|Reject|saving|Invalid Documentation|Duplicate entity found|Registered|
