Feature: Register TaxType Individual Taxpayer  Reject
Scenario Outline: Register TaxType Individual Taxpayer  Reject Scenario
...
Examples:
    ...
    | tripscrmuser11  |Passw0rd | chrome|*ARN/00021477/2020|Read only|Invalid Documentation|Duplicate entity found|Registered|
