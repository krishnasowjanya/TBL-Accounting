Feature: Organization Taxpayer Revision
Scenario Outline:Organization Taxpayer Revision Scenario
...
Then Get Status of Taxpayer "<Status>"
   ...
   Examples:
    ...
    | tripscrmuser11  |Passw0rd | chrome|*ARN/00021434/2020|Reject| saving |Invalid Documentation|Rejected|
