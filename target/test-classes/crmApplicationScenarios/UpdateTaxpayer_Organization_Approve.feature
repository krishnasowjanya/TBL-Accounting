Feature: Update Organization Taxpayer Approve
Scenario Outline:  Update Organization Taxpayer Approve Scenario
 ...
 And Click on NextStage button two times
And Select Approval outcome dropdown value to Approve for Update Ind
...
Examples:
    | username        |password |browser|ReferenceNumber |Read |            ARN|TIN|Status|
    | tripscrmuser11  |Passw0rd | chrome|*ARN/00021462/2020|saving|Processing Completed - Reference Number - ARN|N00|Registered|
