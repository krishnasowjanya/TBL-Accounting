Feature: Transfer TaxPayer Organization Taxpayer Approve
Scenario Outline: Transfer TaxPayer Organization Taxpayer Approve Scenario
...
Examples:
    ...
    | tripscrmuser11  |Passw0rd | chrome|*ARN/00021475/2020|saving|Registered|
