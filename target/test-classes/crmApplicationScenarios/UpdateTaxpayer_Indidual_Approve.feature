Feature: Update Individual Taxpayer Approve
Scenario Outline:  Update Individual Taxpayer Approve Scenario
...
Examples:
    ...
    | tripscrmuser11  |Passw0rd | chrome|*ARN/00021573/2020|saving|Registered|
