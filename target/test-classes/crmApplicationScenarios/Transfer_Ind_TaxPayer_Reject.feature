Feature: Trnsfer TaxPayer Individual Taxpayer  Reject
...
And Enter Outcome Reason for Accounting Module
...
Examples:
    ...
    | tripscrmuser11  |Passw0rd | chrome|*ARN/00021474/2020|Read only|Invalid Documentation|Duplicate entity found|Registered|
