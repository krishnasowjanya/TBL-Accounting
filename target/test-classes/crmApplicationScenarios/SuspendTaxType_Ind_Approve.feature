Feature: Suspend TaxType Individual Taxpayer Approve
Scenario Outline:  Suspend TaxType Individual Taxpayer Approve Scenario
...
Examples:
    ...
    | tripscrmuser11  |Passw0rd | chrome|*ARN/00021479/2020|saving|Registered|
