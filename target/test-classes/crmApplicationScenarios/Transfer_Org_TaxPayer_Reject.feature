Feature: Transfer TaxPayer Organization Taxpayer  Reject
Scenario Outline: Transfer TaxPayer Organization Taxpayer  Reject Scenario
...
Examples:
    ...
    | tripscrmuser11  |Passw0rd | chrome|*ARN/00021476/2020|Read only|Invalid Documentation|Duplicate entity found|Registered|
