Feature: Update Individual Taxpayer Reject
...
Examples:
    ...
    | tripscrmuser11  |Passw0rd | chrome|*ARN/00020214/2020|saving|Invalid Documentation|Duplicate entity found|Registered|
