Feature: Suspend Individual TaxType
Scenario Outline:  Suspend Individual TaxType
 ...
 Then Open Application URL
  ...
  Examples:
    ...
    | tripsuser  |Passw0rd | FireFox|      Individual| N0000026999|SUSPEND TAX TYPE| 09042022|09042025|Processing Completed - Reference Number - ARN|
