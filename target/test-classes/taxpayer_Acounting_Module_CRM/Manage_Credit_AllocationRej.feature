Feature: Manage credit_Allocation Taxpayer Reject Scenario
Scenario Outline:  Manage_Credit_Allocation Taxpayer Reject Scenario
...
Examples:
    ...
    | tripscrmuser11  |Passw0rd | chrome|*CRAL/000001571/2020|Read only|Invalid Documentation|Duplicate entity found|Rejected|
