Feature: Taxpayer Account Adj Credit  Individual Taxpayer Reject Scenario
Scenario Outline:  Taxpayer Account Adj Credit  Individual Taxpayer Reject Scenario
