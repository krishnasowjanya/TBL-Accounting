Feature: Taxpayer Account Adj Debit App Individual Taxpayer Approve
Scenario Outline:  Taxpayer Account Adj Debit App Individual Taxpayer Approve Scenario
