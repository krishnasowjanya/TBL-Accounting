Feature: Taxpayer Account Adj Debit Organization scenario of TaxPayer Accounting Modle
Scenario Outline:Taxpayer Account Adj Debit Organization scenario
...
Examples:
    ...
    | tripsuser  |Passw0rd | chrome |C0000025755 |Liability | Debit |MISCELLANEOUS ADJUSTMENT - DEBIT |1112500| 67587678 |ACAD/| 
