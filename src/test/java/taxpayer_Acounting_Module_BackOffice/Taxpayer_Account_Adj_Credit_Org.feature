Feature: Taxpayer Account Adj Credit Organization scenario of TaxPayer Accounting Modle
Scenario Outline:Taxpayer Account Adj Credit Organization scenario
...
Examples:
    ...
    | tripsuser  |Passw0rd | chrome |N0000026824   |Liability | Credit |MISCELLANEOUS ADJUSTMENT - CREDIT |1112500| 67587678 |ACAD/| 
